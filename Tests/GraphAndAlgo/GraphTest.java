...
class GraphTest {
        ...
        void getNode() {
            ...
            assertEquals(graph.getNode(0), n0);
            assertEquals(graph.getNode(1), n1);
            assertEquals(graph.getNode(2), n2);
            assertEquals(graph.getNode(3), n3);
            assertEquals(graph.getNode(4), n4);
            assertEquals(graph.getNode(5), n5);
            assertEquals(graph.getNode(6), n6);
            assertEquals(graph.getNode(7), n7);
            assertEquals(graph.getNode(8), n8);
            assertEquals(graph.getNode(9), n9);
            assertEquals(graph.getNode(10), n10);
            assertEquals(graph.getNode(11), n11);
            assertEquals(graph.getNode(12), n12);
            assertEquals(graph.getNode(13), n13);
            assertEquals(graph.getNode(14), n14);
            assertEquals(graph.getNode(15), n15);
            assertEquals(graph.getNode(16), n16);
        }
        ...
        void getEdge() {
            ...
            assertEquals(graph.getEdge(0,16), e0);
            assertEquals(graph.getEdge(1,2), e3);
            assertEquals(graph.getEdge(2,6), e6);
            assertEquals(graph.getEdge(5,4), e11);
            assertEquals(graph.getEdge(3,2), e7);
            assertEquals(graph.getEdge(11,12), e25);
            assertEquals(graph.getEdge(16,0), e34);
            assertEquals(graph.getEdge(15,16), e32);
            assertEquals(graph.getEdge(8,9), e19);
            assertEquals(graph.getEdge(7,6), e16);
            assertEquals(graph.getEdge(4,3), e9);
        }
        ...
        @Test
        void connect() {
            graph.connect(0,3,1.734311926030133);
            assertEquals(graph.edgeSize(),37);
            graph.connect(12,5,1.734567926030133);
            assertEquals(graph.edgeSize(),38);
            graph.connect(5,12,1.73456791203133);
            assertEquals(graph.edgeSize(),39);
        ...
        void nodeIter() {
            ...
            graph.addNode(n0);
            Iterator<Vertex> node_iter = graph.nodeIter();
            assertEquals(node_iter.next(),n0);
        }
        ...
        void edgeIter() {
            ...
            graph.addNode(n0);
            graph.addNode(n1);
            graph.connect(0,1,1.232037506070033);

            Iterator<Edge> edge_iter = graph.edgeIter();
            assertEquals(edge_iter.next().getDest(), 1);
        }
        ...
        void edgeIterId() {
            ...
            Iterator<Edge> edge_iter = graph.edgeIter(0);
            assertEquals(edge_iter.next().getDest(), 1);
        }
        ...
        void removeNode() {
            ...
            assertEquals(graph.removeNode(16),n16);
            assertEquals(graph.removeNode(12),n12);
            assertEquals(graph.removeNode(0),n0);
            assertEquals(graph.removeNode(5),n5);
        }
        ...
        void removeEdge() {
            ...
            assertEquals(graph.removeEdge(16,0),e34);
            assertEquals(graph.removeEdge(0,1),e1);
            assertEquals(graph.removeEdge(7,6),e16);
            assertEquals(graph.removeEdge(11,10),e24);
            assertEquals(graph.removeEdge(14,13),e30);
        }
